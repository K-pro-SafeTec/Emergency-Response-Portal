...
const statusIcons = new Map([
  ...
  [Status.WARNING, (props) => <img src={WarningYellow} alt="Advarsel" heigth="35em" width="35em"{...props} />],
  [Status.ERROR, (props) => <img src={Error} alt="OBS!" heigth="35em" width="35em"{...props} />],
]);
